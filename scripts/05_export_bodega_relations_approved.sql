-- =============================================================================
-- EXPORTAR RELACIONES PRODUCTO → BODEGA (SOLO PRODUCTOS APROBADOS)
-- =============================================================================
-- Ejecutar en: SISAM
...
INNER JOIN productos_aprobados pa ON pa.id_alim_producto = bp.id_alim_producto
...
-- 3. Importar en Core como: migration_bodega_producto
-- 4. Ejecutar: 05_migrate_bodega_relations.sql
-- =============================================================================
